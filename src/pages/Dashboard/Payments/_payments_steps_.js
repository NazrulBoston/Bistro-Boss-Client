 ...
 * Install stripe on the server side and get client secret. Make sure used the payment method type:['card'] 
 * 6. from client side get the client secret and save it.
 * 7. use confirm card payment and pass user information, card adn client secret.
